...
const sl: Dict = {
  ...
  hero: {
    ...
    titleConnector: "",
    subtitle:
      "Vsak projekt nastane od prve črte v Figmi do zadnje vrstice kode. Brez predlog, brez bližnjic, ki bi jih čez leto obžalovala.",
  ...
  about: {
    ...
    p1: "V Ljubljani gradim spletne strani in aplikacije za startupe in mala podjetja. Vsak projekt obravnavam, kot da bo moj. Drugače se mi zdi, da ni vredno začeti.",
  ...
  contact: {
    ...
    message: "Sporočilo",
    messagePlaceholder: "Kaj gradiš, kdaj bi moralo biti živo, kakšen je proračun.",
    send: "Pošlji",
    sending: "Pošiljam...",
...
const en: Dict = {
  ...
  hero: {
    ...
    titleConnector: "",
    subtitle:
      "Every project starts at the first Figma stroke and ends at the last line of code. No templates, no shortcuts you'd regret in a year.",
    cta1: "Send a brief",
    cta2: "See projects",
  },
  stats: [
  ...
  about: {
    ...
    p1: "Based in Ljubljana, I build websites and apps for startups and small businesses. Every project gets treated like it's my own. Anything less feels like a waste of both our time.",
