          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <a href="/AjdaZajc_CV.pdf" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-pink-500 dark:hover:text-pink-500">
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <a href="/AjdaZajc_CV.pdf" target="_blank" rel="noopener noreferrer" className="text-pink-500 hover:underline flex items-center gap-1">
            ...
            <div className="group bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all border border-gray-100 dark:border-gray-700">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Angular", "TypeScript", "Ionic", "iOS", "Android"].map((tag) => (
                    <span 
                      key={tag} 
